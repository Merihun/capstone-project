...
KEYPAIR_NAME=Udacity1
DEPLOYMENT_NAME=hello-app
NEW_IMAGE_NAME=registry.hub.docker.com/minuet/hello-app:latest
CONTAINER_PORT=80
HOST_PORT=8080
KUBECTL=./bin/kubectl
...
ci-validate:
	...
	circleci config validate  --ignore-deprecated-images
